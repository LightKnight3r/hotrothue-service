...
module.exports = (req, res) => {
  let { username, name, phone, email, avatar, role, permissions } = req.body || '';
  ...
  async.waterfall([checkParams, checkUserExists, getOldData, updateUser, updateRedisUserData, writeLog], (err, data) => {
    err &&
      _.isError(err) &&
      (data = {
